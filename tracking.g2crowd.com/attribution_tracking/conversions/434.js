(t => {
    ...
    function h(n, e = "") {
        ...
        if (r.setKey(w), !r.isFresh()) {
            if (window.navigator && window.navigator.sendBeacon) {
                ...
                e.append("pid", a), e.append("p", t), e.append("s", o), w.forEach((([t, n]) => e.append(t, n))), window.navigator.sendBeacon(n, e)
    ...
    function f(t) {
        if (c) return !1;
        t ? (c = !0, h(`${n}/attribution_tracking/conversions/assign`, t)) : (g || (h(`${n}/attribution_tracking/conversions/assign`), g = !0), y())
    }

    function u() {
        c || w >= d || (e || (h(`${n}/attribution_tracking/conversions/assign`), c = !0), window.ga && function(t, n) {
            let e;
            ! function(t, n) {
        ...
        }(e, f), window.gtag && function(t, n) {
            window.gtag("get", t, "client_id", n)
        }(e, f), window.dataLayer && function(t, n) {
            window.dataLayer.push(["get", t, "client_id", n]), f("")
        }(e, f), window.gtag || window.ga || y())
    }
    ...
    u()
})("https://www.agorapulse.com/?ref=lapaninja");