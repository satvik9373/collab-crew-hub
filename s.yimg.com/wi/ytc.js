! function(e) {
    ...
    function r() {
        ...
        Array.from || (Array.from = (e = Object.prototype.toString, t = function(t) {
            ...
            for (var s, u = r(i.length), p = t(n) ? Object(new n(u)) : new Array(u), d = 0; d < u;) s = i[d], p[d] = a ? void 0 === o ? a(s, d) : a.call(o, s, d) : s, d += 1;
            return p.length = u, p
    ...
    function oe(e) {
        var t;
        return e.projects && e.properties && (t = [], se(e), ue(e), pe(e, t), delete(e = t).projects, delete e.properties), de(e),
            function(e) {
                var t, n, r;
        ...
        Oe("prerender") ? fe.push(e) : void 0 !== (n = function(e) {
            ...
            try {
                t = t.concat(function(e) {
                    ...
                    var u = e.qstrings;
                    for (var p in u) u.hasOwnProperty(p) && a.push({
                        name: p,
                        value: u[p]
                    });
                    return a
    ...
    var Ee = function() {
            ae = {},
                ...
                }(), me.ytcVersion = "1.16.5", Object.keys(me.emails).length > 0 ? function() {
                    var e = [];
    ...
    function Pe(e, t, n) {
        "collect" === e && "purchase" === t && Se((function() {
            ! function(e, t) {
                ...
                var r = {
                        customKeyValues: n.customKeyValues,
