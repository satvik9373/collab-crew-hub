...
({
    ...
    "./src/assets/scripts/index.js":
        ...
        (function(module, exports, __webpack_require__) {
            ...
            //Add native bootstrap components we need only

            //Add sal for HTML animations

            //Add lozad for lazy loading images and videos

            const observer = lozad(); // lazy loads elements with default selector as '.lozad'
            observer.observe();

            //Smooth scroll for the Trust Center page
            ...
            //Try to automatically send FR/DE/ES traffic to their home page unless they specified a lang pref
            ...
            document.addEventListener('DOMContentLoaded', function(e) {
                ...
                const checkScroll = function() {
                    ...
                    // 1 for scrolled up, 2 for scrolled down
                ...
                let myCollapseInit = new Collapse('button#navcollapse');

                //dropdown menus must be manually initialized
                ...
                let elementsTooltip = document.querySelectorAll('.has-tooltip[title]');
                ...
                var activeCookies = document.querySelector('.active-cookies');
                if (activeCookies) {
                ...
                if (topBannerCookie && buttonCookie) {
                    buttonCookie.addEventListener('click', event => {
                        event.preventDefault();
                        //createCookieBannerTop('cookie_top_banner_accepted', true, 30, domain_variable);
                ...
                var headerBigMenu = document.querySelector('#myNavbar.hv2-big-menu'); // Make sure the selector is correct
                var dropdownsBigMenu = document.querySelectorAll('#myNavbar .dropdown'); // Target the dropdowns, not the toggle buttons

                // Function to add the 'clicked' class
                function addClickedClass() {
                    headerBigMenu.classList.add('clicked');
                }

                // Function to remove the 'clicked' class
                function removeClickedClass() {
                    setTimeout(function() {
                        // Check if no other dropdown is open before removing the class
                        if (!document.querySelector('.dropdown.show')) {
                            headerBigMenu.classList.remove('clicked');
                        }
                    }, 100); // Delay in milliseconds, adjust as needed
                }

                // Add event listeners to dropdown elements
                dropdownsBigMenu.forEach(function(dropdown) {
                    // When the dropdown is shown
                    dropdown.addEventListener('show.bs.dropdown', addClickedClass);

                    // When the dropdown is hidden
                    dropdown.addEventListener('hide.bs.dropdown', removeClickedClass);
                });
            });
    ...
    3:
        ...
        (function(module, exports, __webpack_require__) {
            ...
            __webpack_require__( /*! D:\www\website-www\src\assets\scripts\index.js */ "./src/assets/scripts/index.js");
            module.exports = __webpack_require__( /*! D:\www\website-www\src\assets\styles\index.scss */ "./src/assets/styles/index.scss");
