function UET(o) {
    ...
    this._push = function(n) {
        ...
        if (n[1] instanceof Array)
            ...
            if (t.hasOwnProperty("source") && this.stringExists(t.source) && t.source.indexOf("gtm_") === 0) {
    ...
    this.shouldEnforce = function(n) {
        return this.uetConfig.consent.enabled === !0 || this.uetConfig.tcf.enabled === !0 ? !1 : this.uetConfig.cusig.blob.bi === !0 ? !0 : this.uetConfig.cusig.blob.co !== "de" && this.uetConfig.cusig.blob.co !== "nl" ? !1 : this.uetConfig.cusig.blob.dt === !0 ? !0 : this.uetConfig.cusig.blob.at === !0 ? !1 : n.hasCookie === !1 ? !0 : !1
    };
