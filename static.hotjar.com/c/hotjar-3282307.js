window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "polls": [{
        ...
        "content": {
            "version": 2,
            "questions": [{
                "uuid": "f0dc52ad-d22e-45ec-8dda-e75a4d142146",
                "type": "reaction",
                "text": "Was this blog post useful?",
                "required": true,
                "labels": [{
                    "text": "No, not at all"
                }, {
                    "text": "Yes, very useful"
                }],
                "reaction_style": "default",
                "next": "byOrder"
            }, {
                "uuid": "ac4d0cff-76b0-472a-afb1-bf35792c2ef0",
                ...
                "uuid": "cf2850b5-6ed3-4073-9fb7-4065a495c095",
                "type": "email",
                "text": "We may want to follow up with you to improve our blog content. Please include your email below:",
                "required": false,
                "nextIfSkipped": "byOrder",
                "next": "thankYou"
            }],
        ...
        "targeting": [{
            ...
            "negate": false,
            "pattern": "https://agorapulse.com/blog/",
            "name": null,
            "rule_type": null
        }, {
            "component": "device",
        ...
        "uuid": "ca2e2d3a-5e13-45dc-be91-527bbd26cdbc",
        "invite": {
    ...
    "features": ["error_reporting", "survey.type_button", "feedback.embeddable_widget", "settings.billing_v2", "client_script.compression.pc", "survey.screenshots", "ask.popover_redesign", "feedback.widgetV2", "survey.embeddable_widget", "survey.image_question"],
...
! function() {
    ...
    var j, S, E, T, R, M, O, A, x, C, N, I, k, U, P, B = hj.metrics.start(),
        D = !(!window.CS_CONF || null === (y = window.CS_CONF.voc) || void 0 === y || !y.enabled),
        F = !(window.CS_CONF || !(null !== (_ = window.hjSiteSettings.features) && void 0 !== _ && _.includes("cs_lite") || window._hjSettings.csid));
    if (window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.902ba72730e94f8c2fc4.js"
            },
            SURVEY_BOOTSTRAPPER: {
                js: "survey-bootstrapper.4ecdf9f80441999f25f8.js"
            },
            SURVEY_ISOLATED: {
                js: "survey-isolated.2c26d4aeac750f2f7d08.js"
            },
            HEATMAP_RETAKER: {
                js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js"
            },
            SURVEY_INVITATION: {
                js: "survey-invitation.56858aaccbc6cd4e039e.js"
            },
            NOTIFICATION: {
                js: "notification.86732657079a99e6ce8a.js"
            },
            PREACT_INCOMING_FEEDBACK: {
                js: "preact-incoming-feedback.c734b48cc2e5d195d87b.js"
            },
            SENTRY: {
            ...
            USER_TEST: {
                js: "user-test.09ec3271a1098a74b6a3.js"
            }
        }, D) window._uxa.push(["start:hotjar", window.hjSiteSettings]);
    else if (F) {
        var L = (M = (j = window.hjSiteSettings).suppress_all || j.suppress_text || (null === (S = j.suppress_all_on_specific_pages) || void 0 === S ? void 0 : S.length), O = function(e) {
                var t, n, r, i, a, o = {
                ...
                return o
            }(j), A = O.anonymisationMethod, x = O.replayRecordingMaskedUrlRegex, C = O.replayRecordingMaskedUrlRegexRules, {
                CS_CONF_BASE: {
                    projectId: j.cs_project_id,
                    hostnames: [window.location.hostname],
                    sampleRate: j.continuous_capture_enabled ? 100 : 100 * j.rec_value,
                    replayRecordingRate: j.record ? 100 : 0,
                    jsErrorsEnabled: j.session_capture_console_consent,
                    customError: j.session_capture_console_consent && {
                        enabled: !0,
                        consoleMessageLogLevels: ["error"]
                    },
                    voc: null !== (E = j.feedback_widgets) && void 0 !== E && E.length || null !== (T = j.polls) && void 0 !== T && T.length ? {
                        enabled: 1,
                        siteId: j.site_id
                    } : {
                        enabled: 0
                    },
                    whitelistedAttributes: !M && j.recording_capture_keystrokes ? ["data-hj-allow"] : [],
                    anonymizeDigits: !!M || j.anonymize_digits,
                    anonymizeEmails: !!M || j.anonymize_emails,
                    implementations: (N = j, I = m, k = "manual" === (P = N.state_change_listen_mode) ? [] : [{
                        template: {
                        ...
                        triggers: [{
                            name: "HistoryChange",
                            args: {
                                listeners: "popstate, pushState, replaceState" + ("automatic_with_fragments" === P ? ", hashchange" : ""),
                                useDebounce: "no",
                                window: 400
                            }
                        }]
                    }], k && !Array.isArray(k) && "number" == typeof k.length ? v(k, k.length) : I(k, U)),
                    anonymisationMethod: A,
                    replayRecordingMaskedUrlRegex: x,
                    replayRecordingMaskedUrlRegexRules: C
                },
                PII_SELECTORS: j.suppress_all || (null === (R = j.suppress_all_on_specific_pages) || void 0 === R ? void 0 : R.length) ? ["img, video, source"] : null
            }),
            z = L.CS_CONF_BASE,
            V = L.PII_SELECTORS;
        window.CS_CONF_BASE = z, window._uxa = window._uxa || [], V && window._uxa.push(["setPIISelectors", {
            PIISelectors: V
        }]);
        var H = window._hjSettings.environment,
            q = "t.contentsquare.net";
        H && "live" !== H && (window._hjSettings.csid && (window.CS_CONF_BASE.projectId = window._hjSettings.csid), q = "t-staging.contentsquare.net");
        var Y = document.createElement("script");
        Y.type = "text/javascript", Y.async = !0, Y.src = "//".concat(q, "/uxa/smb/tag.js"), document.getElementsByTagName("head")[0].appendChild(Y)
        ...
        d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", u.appendChild(d), c.revision = "b309d13", window.hjBootstrap = c
    }, window.hjBootstrap("https://script.hotjar.com/", "modules.6e8cbd39caed17f0d1c0.js", "3282307"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: B,
